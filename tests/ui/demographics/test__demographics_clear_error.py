...
class DemographicsClearErrorViewTester(FlaskViewTester):
    @property
    def endpoint(self):
        return 'ui.demographics_clear_error'
...
class TestDemographicsClearErrorRequiresLogin(DemographicsClearErrorViewTester, RequiresLoginTester):
    ...


class TestDemographicsClearErrorRequiresAdmin(DemographicsClearErrorViewTester, RequiresRoleTester):
    @property
...
@patch('identity.ui.views.demographics.schedule_lookup_tasks') # Mocking as cereal tasks do not work in testing
class TestDemographicsClearErrorGet(DemographicsClearErrorViewTester, FlaskViewLoggedInTester):
    @cache
