...
def test__get_pmi__uhl_found(client, faker, mock_pmi_engine):
    expected = faker.pmi_data().get(save=False)
    mock_pmi_engine.return_value.__enter__.return_value.execute.return_value.fetchall.side_effect = [[], [expected]]
...
def test__get_pmi__nhs_multiple(client, faker, mock_pmi_engine):
    expected = faker.pmi_data().get(save=False)
    mock_pmi_engine.return_value.__enter__.return_value.execute.return_value.fetchall.side_effect = [[expected, faker.pmi_data().get(save=False)], []]
...
def test__get_pmi__uhl_multiple(client, faker, mock_pmi_engine):
    expected = faker.pmi_data().get(save=False)
    mock_pmi_engine.return_value.__enter__.return_value.execute.return_value.fetchall.side_effect = [[], [faker.pmi_data().get(save=False), faker.pmi_data().get(save=False)]]
...
def test__get_pmi__differ(client, faker, mock_pmi_engine):
    expected = faker.pmi_data().get(save=False)
    mock_pmi_engine.return_value.__enter__.return_value.execute.return_value.fetchall.side_effect = [[expected], [faker.pmi_data().get(save=False)], [faker.pmi_data().get(save=False)]]
