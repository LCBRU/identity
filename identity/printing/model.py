...
class BagContext():
    def __init__(self, printer, participant_id, side_bar, small_fonts=False):
        ...
        if small_fonts:
            self.FONT_SMALL = _FONT_SMALL
            self.FONT_MEDIUM = _FONT_SMALL
            self.FONT_LARGE = _FONT_MEDIUM
            self.FONT_TITLE = _FONT_LARGE
        else:
            self.FONT_SMALL = _FONT_SMALL
            self.FONT_MEDIUM = _FONT_MEDIUM
            self.FONT_LARGE = _FONT_LARGE
            self.FONT_TITLE = _FONT_TITLE
